...
public class ChatController {
    ...
    public Mensagem enviar(@PathVariable String sala, Mensagem mensagem, Principal principal){
        SalaChat salaChat = salaChatRepository.findByCodigo(sala).orElseThrow(() -> new ResourceNotFoundException("Sala não encontrada"));
